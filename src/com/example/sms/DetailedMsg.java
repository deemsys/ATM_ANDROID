	...
	DatabaseHandler dbHandler = new DatabaseHandler(this);
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	       ...
	       System.out.println("id in detailed view::"+USER);
	       System.out.println("Msg id in detailed View:::"+Msg_ID);
		  ...
		  dbHandler.Update_Contact(new Message(userr_iid,USER,frommmm,tooooo,mmmms,dattt,status));
